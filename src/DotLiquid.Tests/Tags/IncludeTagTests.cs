...
namespace DotLiquid.Tests.Tags
{
    ...
    public class IncludeTagTests
    {
        ...
        {
            var config = TemplateConfiguration.CreateStandartConfiguration().SetFileSystem(new InfiniteFileSystem());
        ...
        {
            var config = TemplateConfiguration.CreateEmptyConfiguration().SetFileSystem(new LocalFileSystem(string.Empty));
        ...
        {
            var config = TemplateConfiguration.CreateEmptyConfiguration()
                .SetFileSystem(new TestFileSystem())
